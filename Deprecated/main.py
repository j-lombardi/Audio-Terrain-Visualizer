"""
    Initial prototype of our GUI design using PyQt5. This used matplotlip to display fluff data for something to
    visualize.
"""
...
from mpl_toolkits.mplot3d import Axes3D  # used for plotting 3d graphs
